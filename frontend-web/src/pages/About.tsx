            ...
            <section className="pt-32 pb-20 bg-dark-950">
                <div className="max-w-7xl mx-auto px-6">
                    <div className="text-center">
                        <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">About DaaS Platform</h1>
                ...
                <div className="max-w-7xl mx-auto px-6">
                    <div className="grid lg:grid-cols-2 gap-12 items-center">
                        ...
                        <div className="grid grid-cols-2 gap-4">
                            <div className="p-6 rounded-2xl border border-dark-800 bg-dark-900 text-center">
                                <div className="text-4xl font-bold text-primary-500">2023</div>
                            ...
                            <div className="p-6 rounded-2xl border border-dark-800 bg-dark-900 text-center">
                                <div className="text-4xl font-bold text-primary-500">$15M</div>
            ...
            <section className="py-20 bg-dark-950">
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
                        {values.map((value) => (
                            <div key={value.title} className="p-6 rounded-2xl border border-dark-800 bg-dark-900 text-center">
                                <div className="w-14 h-14 rounded-xl bg-dark-800 flex items-center justify-center mx-auto mb-4">
            ...
            <section className="py-20 bg-dark-950">
                <div className="max-w-7xl mx-auto px-6">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
                        {team.map((member) => (
                            <div key={member.name} className="p-6 rounded-2xl border border-dark-800 bg-dark-900 text-center">
                                <div className="w-20 h-20 rounded-full bg-primary-500 flex items-center justify-center mx-auto mb-4 text-2xl font-bold text-white">
                                    {member.avatar}
                                </div>

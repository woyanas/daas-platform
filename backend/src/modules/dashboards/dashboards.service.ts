...
export class DashboardsService {
    ...
    // Widget methods
    async addWidget(dashboardId: string, userId: string, dto: CreateWidgetDto): Promise<Widget> {
    ...
    async updateWidget(widgetId: string, userId: string, dto: UpdateWidgetDto): Promise<Widget> {
    ...
    async getAnalytics(userId: string) {
        const totalDashboards = await this.dashboardsRepository.count({ where: { userId } });
